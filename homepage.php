...
<body style="background-image: linear-gradient(135deg, #71b7e6, #9b59b6); height:100vh;">
  ...
  <div class="container-fluid text-center" style="margin-top: 4rem;">
    <div class="row justify-content-around">
      <div class="col-1"></div>
      <div class="col-3">
        <div class="card border-dark mb-3 animate__animated animate__pulse animate__infinite animate__slower animate__delay-1s" style="color:black; max-width: 18rem;background-color: rgba(155,89,182,.25);">
      ...
      <div class="col-3">
        <div class="card border-dark mb-3 animate__animated animate__pulse animate__infinite animate__slower animate__delay-2s" style="color: black;max-width: 18rem;background-color: rgba(155,89,182,.25);">
          <div class="card-header">
            <span class="material-symbols-outlined">
              approval_delegation
              </span>
      ...
      <div class="col-3">
        <div class="card border-dark mb-3 animate__animated animate__pulse animate__infinite animate__slower animate__delay-3s" style="color:black; max-width: 18rem;background-color: rgba(155,89,182,.25);">
          <div class="card-header">
            <span class="material-symbols-outlined">
              biotech
              </span>
